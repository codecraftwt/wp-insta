                                        ...
                                        <div class="col-md-6 ">
                                            <div class="row mt-1">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" id="total_usage"
                                                        value="{{ $userStorage['totalusages'] }}" class="form-control"
                                                        readonly>
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="storage_limit"><strong>Storage Limit:</strong></label>
                                                    <input type="text" id="storage_limit"
                                                        value="{{ $userStorage['storage'] }}" class="form-control" readonly>
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="usersite"><strong>Number of Sites:</strong></label>
                                                    <input type="text" id="usersite"
                                                        value="{{ $userStorage['usersite'] }}" class="form-control"
                                                        readonly>
                                                </div>
                                            </div>
                                        </div>
